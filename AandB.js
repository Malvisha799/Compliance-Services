  ...
  pvt: [
    {
      ...
      status: "completed",
      description: "Preparation and approval of financial statements",
    },
    {
      title: "Board Meeting",
      deadline: "Quarterly",
      status: "pending",
      description: "Mandatory board meetings as per Companies Act",
    },
    {
      title: "Annual Return (MGT-7)",
      deadline: "Within 60 days of AGM",
      status: "upcoming",
      description: "Filing of annual return with ROC",
    },
    {
      title: "Income Tax Return",
      deadline: "30th November",
      status: "pending",
      description: "Filing of company income tax return",
    },
  ],
  llp: [
    {
    ...
    },
    {
      ...
      deadline: "31st July",
      status: "upcoming",
      description: "Filing of LLP income tax return",
    },
    {
      title: "Partner Meeting",
      deadline: "Half-yearly",
      status: "pending",
      description: "Mandatory partner meetings",
    },
  ],
};
...
// Render functions
function renderTimeline(type = "pvt") {
  const timelineContainer = document.querySelector(".timeline-container");
  timelineContainer.innerHTML = "";

  complianceTimelines[type].forEach((item1) => {
    const timelineItem = document.createElement("div");
    timelineItem.className = `timeline-item ${item1.status}`;
    timelineItem.innerHTML = `
            <div class="timeline-content">
                <h4>${item1.title}</h4>
                <p><strong>Deadline:</strong> ${item1.deadline}</p>
...
function initializeTabs() {
  ...
  tabs.forEach((tab) => {
    tab.addEventListener("click", () => {
      ...
      renderTimeline(tab.dataset.type);
    });
  });
}
